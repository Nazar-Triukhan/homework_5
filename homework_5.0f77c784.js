...
})({"5abXb":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 62988;
...
var _btnIf = require("./js/btnIf");
var _btnIfDefault = parcelHelpers.interopDefault(_btnIf);
var _keyApp = require("./js/keyApp");
var _keyAppDefault = parcelHelpers.interopDefault(_keyApp);
var _keys = require("./js/keys");
var _keysDefault = parcelHelpers.interopDefault(_keys);
var _pnotify = require("./js/pnotify");
var _pnotifyDefault = parcelHelpers.interopDefault(_pnotify);
// 2 завдання
var _auto = require("chart.js/auto");
var _autoDefault = parcelHelpers.interopDefault(_auto);
(0, _pnotifyDefault.default).info({
    text: "\u0413\u0440\u0430 \u043A\u043B\u0430\u0432\u0456\u0430\u0442\u0443\u0440\u0438",
    delay: 1500
});
...
keyClick.textContent = (0, _keysDefault.default)[state.currentKeyIndex];
(0, _btnIfDefault.default)({
    btn: btnRef,
    state,
    numberRef,
    keyClick,
    keys: (0, _keysDefault.default)
});
(0, _keyAppDefault.default)({
    keyClick,
    keyRef,
    numberRef,
    state,
...
const myChart = new (0, _autoDefault.default)(ctx, config);

},{"./js/btnIf":"j4Mv8","./js/keyApp":"5Jqqs","./js/keys":"bVvHK","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./js/pnotify":"3C6nY","chart.js/auto":"a3bOj"}],"j4Mv8":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>btnIf);
var _pnotify = require("./pnotify");
var _pnotifyDefault = parcelHelpers.interopDefault(_pnotify);
function btnIf({ btn, state, numberRef, keyClick, keys }) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./pnotify":"3C6nY"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
exports.default = {
    alert: (0, _core.alert),
    notice: (0, _core.notice),
    info: (0, _core.info),
    success: (0, _core.success),
    error: (0, _core.error)
};

},{"@pnotify/core/dist/BrightTheme.css":"grIyt","@pnotify/core/dist/PNotify.css":"c4y47","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","@pnotify/core":"fay4s","@pnotify/mobile":"5RXYV"}],"grIyt":[function() {},{}],"c4y47":[function() {},{}],"fay4s":[function(require,module,exports,__globalThis) {
var global = arguments[3];
!function(t, e) {
    e(exports);
}(this, function(t) {
...
},{}],"5Jqqs":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>keyApp);
var _pnotify = require("./pnotify");
var _pnotifyDefault = parcelHelpers.interopDefault(_pnotify);
function keyApp({ keyClick, keyRef, numberRef, state, keys }) {
    window.addEventListener("keydown", (e)=>{
        if (e.key === "Enter" || e.key === " ") e.preventDefault();
        if (state.currentKeyIndex === keys.length - 1) (0, _pnotifyDefault.default).alert({
        ...
        if (e.key.toLowerCase() === keys[state.currentKeyIndex].toLowerCase()) {
            ...
            if (keys.length !== state.currentKeyIndex) keyClick.textContent = keys[state.currentKeyIndex];
            else return;
        } else {
            const trueKey = keys.findIndex((el)=>el.toLowerCase() === e.key.toLowerCase());
            if (trueKey === -1) return;
            else {
                (0, _pnotifyDefault.default).error({
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./pnotify":"3C6nY"}],"bVvHK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const keys = [
    "`",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"a3bOj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5abXb","2R06K"], "2R06K", "parcelRequireaf09", {})

//# sourceMappingURL=homework_5.0f77c784.js.map
